var React = require('react'),
  extend = require("101/assign"),
  ReactTypeahead;

ReactTypeahead = React.createClass({
  displayName: "ReactTypeahead",
  /**
   * 'initOptions' method
  ...
  render: function() {
    return (
      <input className="typeahead form-control onehunned" type="text" placeholder={this.props.placeHolder} />
    );
  },
